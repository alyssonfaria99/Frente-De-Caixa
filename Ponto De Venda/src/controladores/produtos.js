...
const s3 = require('../servicos/awssdk');
...
const cadastrarProduto = async (req, res) => {
    ...
    try {
        ...
        return res.status(400).json({ mensagem: "Eror interno do servidor", message: error.message });
    };
};
...
const excluirProduto = async (req, res) => {
    ...
    try {
        ...
        return res.status(500).json({ mensagem: "Erro interno do servidor", message: error.message });
    }
};
